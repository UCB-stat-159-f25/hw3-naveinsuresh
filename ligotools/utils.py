...
# plotting function for cell #30
def plotting_func(det, strain_L1_whitenbp, strain_H1_whitenbp, template_match, time, timemax, tevent, SNR, datafreq, d_eff, template_fft, freqs, data_psd, fs, eventname, plottype):
